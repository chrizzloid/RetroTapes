...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.ActorId).HasName("PK__actor__8B2447B422F2400E");
        ...
        {
            entity.HasKey(e => e.AddressId).HasName("PK__address__CAA247C8F43D9C09");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__category__D54EE9B40E25CE9D");
        ...
        {
            entity.HasKey(e => e.CityId).HasName("PK__city__031491A8401EF8D4");
        ...
        {
            entity.HasKey(e => e.CountryId).HasName("PK__country__7E8CD055DF24035C");
        ...
        {
            entity.HasKey(e => e.CustomerId).HasName("PK__customer__CD65CB85583B59C0");
        ...
        {
            entity.HasKey(e => e.FilmId).HasName("PK__film__349764A9B8CD0D16");
        ...
        {
            entity.HasKey(e => new { e.ActorId, e.FilmId }).HasName("PK__film_act__086D31FECA82AC99");
        ...
        {
            entity.HasKey(e => new { e.FilmId, e.CategoryId }).HasName("PK__film_cat__69C38A328EB0F374");
        ...
        {
            entity.HasKey(e => e.FilmId).HasName("PK__film_tex__349764A9D7D4BF07");
        ...
        {
            entity.HasKey(e => e.InventoryId).HasName("PK__inventor__B59ACC49A232CFB8");
        ...
        {
            entity.HasKey(e => e.LanguageId).HasName("PK__language__804CF6B387E7DDA7");
        ...
        {
            entity.HasKey(e => e.PaymentId).HasName("PK__payment__ED1FC9EA086038D5");
        ...
        {
            entity.HasKey(e => e.RentalId).HasName("PK__rental__67DB611B4865A07A");
        ...
        {
            entity.HasKey(e => e.StaffId).HasName("PK__staff__1963DD9C0EAD06A5");
        ...
        {
            entity.HasKey(e => e.StoreId).HasName("PK__store__A2F2A30C026725D4");
        ...
        modelBuilder.Entity<VwActiveCustomer>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("vw_ActiveCustomers");
